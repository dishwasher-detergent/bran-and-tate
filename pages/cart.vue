<template>
  <div>
    <div class="mx-auto max-w-7xl px-5 h-full py-10">
      <div>
      ...
      >
        <div
          class="h-48 w-full md:w-24 md:h-24 flex-none rounded-2xl bg-gray-50 overflow-hidden"
        >
          <ProductImg :id="item.image" :alt="item.name" height="200" width="200"/>
        </div>
