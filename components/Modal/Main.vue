		...
		<transition name="slide">
			...
			>
				...
				<div class="w-full h-96 flex-none bg-gray-200 flex items-center justify-center">
					<button aria-label="Close Modal" @click='close' class="z-50 h-6 w-6 absolute top-0 right-0 mt-2 mr-4 ring-1 ring-red-500 p-1 bg-red-200 text-red-500 rounded-full">
