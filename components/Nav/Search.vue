<template>
	<div class="p-3 h-16 md:h-full w-full flex items-center justify-center">
		...
		<input v-model="search" type='text' class="h-full w-full rounded-2xl bg-gray-50 border-gray-300 border pl-5 pr-10 truncate focus:bg-white focus:ring-blue-500" />
