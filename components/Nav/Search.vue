<template>
	<div class="p-3 h-16 md:h-full w-full flex items-center justify-center">
		...
		<input v-model="search" type='text' class="h-full w-full rounded-full bg-gray-100 ring-gray-300 ring-2 pl-5 pr-10 truncate focus:bg-white focus:ring-blue-500" />
